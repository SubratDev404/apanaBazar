...
class NoItemInWishList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: NoItemInWishListScreen(),
    );
  }
}

class NoItemInWishListScreen extends StatefulWidget {
  
  @override
  _NoItemInWishListScreenState createState() => _NoItemInWishListScreenState();
}

class _NoItemInWishListScreenState extends State<NoItemInWishListScreen> {
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              Text('Your WishList is Empty',style: TextStyle(color: Colors.grey,fontFamily: 'Montserrat',fontWeight: FontWeight.w800,fontSize: 20),)
