...
class NoItemInCart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: NoItemInCartScreen(),
    );
  }
}

class NoItemInCartScreen extends StatefulWidget {
  
  @override
  _NoItemInCartScreenState createState() => _NoItemInCartScreenState();
}

class _NoItemInCartScreenState extends State<NoItemInCartScreen> {
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              Text('Your Cart is Empty',style: TextStyle(color: Colors.grey,fontFamily: 'Montserrat',fontWeight: FontWeight.w800,fontSize: 20),)
            ],
