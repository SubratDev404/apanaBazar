...
class PasswordChangeSuccessfully extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: PasswordChangeSuccessfullyScreen(),
    );
  }
}
...
class PasswordChangeSuccessfullyScreen extends StatefulWidget {
  ...
  @override
  _PasswordChangeSuccessfullyScreenState createState() => _PasswordChangeSuccessfullyScreenState();
}

class _PasswordChangeSuccessfullyScreenState extends State<PasswordChangeSuccessfullyScreen> {
      ...
      body: Container(
        child: Center(
          child: Column(
            ...
            children: [
              Image.asset("assets/images/update_password.png",height: 300,fit: BoxFit.fill,),

              SizedBox(
                height: 20,
              ),
              Text('Password is updated',style: TextStyle(color: Colors.green,fontFamily: 'Montserrat',fontWeight: FontWeight.bold,fontSize: 25),),
