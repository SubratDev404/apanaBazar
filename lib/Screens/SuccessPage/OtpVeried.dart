...
class _OtpVerifiedScreenState extends State<OtpVerifiedScreen> {
  ...
  void initState() {
   ...
   // BackButtonInterceptor.add(myInterceptor);
    Timer(Duration(seconds: 2),()=>Navigator.pushReplacement(context, MaterialPageRoute(builder:(context)=>ForgotPasswordChange())));
  }
      ...
      body: Container(
        child: Center(
          child: Column(
            ...
            children: [
              Image.asset("assets/images/otp_verified.png",height: 300,fit: BoxFit.fill,),
              Text('OTP is Verified',style: TextStyle(color: Colors.green,fontFamily: 'Montserrat',fontWeight: FontWeight.bold,fontSize: 25),),
