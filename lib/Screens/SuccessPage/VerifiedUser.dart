...
class VerifiedUserScreen extends StatefulWidget {
  ...
  @override
  _VerifiedUserScreenState createState() => _VerifiedUserScreenState();
}
...
class _VerifiedUserScreenState extends State<VerifiedUserScreen> {
  ...
  void initState() {
    ...
    Timer(Duration(seconds: 4),()=>Navigator.pushReplacement(context, MaterialPageRoute(builder:(context)=>ForgotPasswordOtpVerify())));
  }
      ...
      body: Container(
        child: Center(
          child: Column(
            ...
            children: [
              Image.asset("assets/images/verifieduser.png",height: 300,fit: BoxFit.fill,),
              Text('OTP has sent on',style: TextStyle(color: Colors.green,fontFamily: 'Montserrat',fontWeight: FontWeight.bold,fontSize: 25),),
              Text(ForgotPassword.email.toString(),style: TextStyle(color: Colors.green,fontFamily: 'Montserrat',fontWeight: FontWeight.bold,fontSize: 18),),
              Text('Successfully',style: TextStyle(color: Colors.green,fontFamily: 'Montserrat',fontWeight: FontWeight.bold,fontSize: 18),)
            ],
