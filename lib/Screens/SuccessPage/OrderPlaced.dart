...
class _OrderPlacedScreenState extends State<OrderPlacedScreen> {
  ...
  @override
    void initState() {
      ...
      Timer(Duration(seconds: 3),()=>Navigator.pushReplacement(context, MaterialPageRoute(builder:(context)=>CurvedBottomNavigationBar())));
  }
      ...
      body: Container(
        child: Center(
          child: Column(
            ...
            children: [
              Image.asset("assets/images/ordered.gif",height: 300,fit: BoxFit.fill,),
              Text('Order Placed Successfully',style: TextStyle(color: Colors.green,fontFamily: 'Montserrat',fontWeight: FontWeight.bold,fontSize: 25),)
            ],
