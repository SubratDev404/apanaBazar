...
import 'package:apanabazar/Model/CreateAddressModel.dart';
...
class CreateCheckOutAddress extends StatelessWidget {
...
class _CreateAddressScreenState extends State<CreateAddressScreen> {
  ...
  Future<CreateAddressModel> createAddressProcess() async {
    const createAddress_url='https://api.apanabazar.com/api/webdeliveryaddress';
    final http.Response response = await http.post(
        ...
        body: json.encode({
          ...
          'addressType' : CreateCheckOutAddress.radioButtonid
    ...
    if (response.statusCode == 200) {
      ...
      // print('login body');
      // print(response.body);
       return CreateAddressModel.fromJson(json.decode(response.body));
    } else {
  ...
  void initState() {
    ...
    super.initState();
    fetchAddressList();
    CreateCheckOutAddress.radioButtonid=1;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: themColor,
        elevation: 0.0,
        title: Center(child: Text('Create Address',style: TextStyle(color: Colors.white,fontFamily: 'Montserrat',fontWeight: FontWeight.w800,fontSize: 20),),),
        leading: IconButton(
                                  ...
                                  fList.map((data) => RadioListTile(
                                    ...
                                    onChanged: (val) {
                                      setState(() {
                                        radioItem = data.name ;
                                        id = data.index;
                                        CreateCheckOutAddress.radioButtonid=id;
                            ...
                            Padding(
                              ...
                              child: SizedBox(
                                ...
                                child: ElevatedButton.icon(
                                  ...
                                  label: Text('Save Address', style: TextStyle(color: Colors.white,fontSize: 18,fontWeight: FontWeight.bold,fontFamily: "Roboto")),
                                  onPressed: 
                                    ...
                                    //snapshot.hasData
                                       ...
                                       () async{
                                        ...
                                        try{
                                          ...
                                          CreateCheckOutAddress.fulladdress=response.data.fulladdress.toString();
                                          CreateCheckOutAddress.additionalinfo=response.data.additionalinfo.toString();
                                          CreateCheckOutAddress.pincode=response.data.pincode.toString();
                                          CreateCheckOutAddress.userid=response.data.id;
