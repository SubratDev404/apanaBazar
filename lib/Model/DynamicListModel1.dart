...
//
//     final popularListModel = popularListModelFromJson(jsonString);

import 'dart:convert';

DynamicListModel1 popularListModelFromJson(String str) => DynamicListModel1.fromJson(json.decode(str));

String popularListModelToJson(DynamicListModel1 data) => json.encode(data.toJson());

class DynamicListModel1 {
    DynamicListModel1({
        this.status,
        this.data,
    });
    ...
    factory DynamicListModel1.fromJson(Map<String, dynamic> json) => DynamicListModel1(
        status: json["status"],
