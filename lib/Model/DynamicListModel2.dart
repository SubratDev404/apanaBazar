...
//
//     final trendingListModel = trendingListModelFromJson(jsonString);

import 'dart:convert';

DynamicListModel2 dynamicListModelFromJson(String str) => DynamicListModel2.fromJson(json.decode(str));

String dynamicListModelToJson(DynamicListModel2 data) => json.encode(data.toJson());

class DynamicListModel2 {
    DynamicListModel2({
        this.status,
        this.data,
    });
    ...
    factory DynamicListModel2.fromJson(Map<String, dynamic> json) => DynamicListModel2(
        status: json["status"],
